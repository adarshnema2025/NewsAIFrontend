            ...
            <div className="w-full max-w-md animate-fade-in">
                ...
                <div className="card p-8">
                    ...
                    {/* <a
                        ...
                        className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 text-sm font-medium hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors duration-200 shadow-sm"
                    >
                    ...
                    <p className="mt-6 text-center text-sm text-slate-500 dark:text-slate-400">
                        ...
                        <Link to="/signup" className="text-accent dark:text-accent-dark font-medium hover:underline">
                            Create one
                        </Link>
                    </p>
                </div>
